...
<form id="registerForm" action="/register" method="post" class="space-y-4">
    ...
    <button type="submit"
            class="submit-button w-full bg-orange-600 text-white py-2 px-4 rounded-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200">
        Registruj se
    </button>
</form>
    <p class="mt-4 text-center text-sm text-gray-600">
        <a href="/login" class="text-orange-600 hover:underline">Već imate nalog? Prijavite se</a>
    </p>
</div>